<div class="container-fluid">
    ...
    <table class="table table-bordered text-center">
        ...
        <tr>
            ...
            <td>
                <?php echo anchor('admin/data_barang/edit/' .$brg->id_brg, '<div class="btn btn-primary btn-sm"><i
                        class="fas fa-edit"></i>
                </div>') ?>
            </td>
            <td>
                <?php echo anchor('admin/data_barang/hapus/' .$brg->id_brg, '<div class="btn btn-danger btn-sm"><i
