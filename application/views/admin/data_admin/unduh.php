...
<html>
    ...
    <body>
		<div class="table-data" style="font-family:'Poppins', sans-serif;display: flex;flex-wrap: wrap;grid-gap: 24px;margin-top: 24px;width: 100%;color: #342E37;">
				<div class="order">
					<h1 style="text-align: center">Data Admin Warung Marena</h1>
					...
					<table  style="width: 100%;border-collapse: collapse;">
						<thead>
							<tr>
								...
								<th style="text-align: center; width: 50px;padding: 30px 10px;font-size: 17px;text-align: center;background-color: #005DD1;color: white;">Role</th>
						...
						<tbody>
							<tr>
								<td style="padding: 16px 0;text-align: center;background: #B6DBF6;"><?php echo $admn->id ?></td>
								<td style="padding: 16px 0;text-align: center;background: #B6DBF6;"><?php echo $admn->nama ?></td>
								<td style="padding: 16px 0;text-align: center;background: #B6DBF6;"><?php echo $admn->role ?></td>
								<td style="padding: 16px 0;text-align: center;background: #B6DBF6;"><?php echo $admn->username ?></td>
								<td style="padding: 16px 10px;text-align: center;background: #B6DBF6;"><?php echo $admn->email ?></td>
